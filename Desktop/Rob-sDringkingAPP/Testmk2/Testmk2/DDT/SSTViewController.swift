...
class SSTViewController: UIViewController {
    ...
    let pages:[Dictionary<String, Any>] = [[
        "labels": [[
            ...
            "frame": CGRect(x:20, y:20, width:UIScreen.main.bounds.height - 40, height: 24),
            "fontSize": 24
            ],
                   [
                    "text": "Your task is to respond as FAST and ACCURATELY as possible to these (go) stimuli:",
                    "line": 2,
                    "frame": CGRect(x:20, y:54, width:UIScreen.main.bounds.height - 40, height: 60),
                    "fontSize": 24
            ],
                   [
                    "text": "Press X using your left hand when you see an X",
                    "line": 1,
                    "frame": CGRect(x:40, y:132, width:UIScreen.main.bounds.height - 60, height: 40),
                    "range": [
                        "text": " X ",
                        "color": UIColor.green
                    ]
                   ...
                   [
                    ...
                    "line": 1,
                    "frame": CGRect(x:40, y:202, width:UIScreen.main.bounds.height - 60, height: 40),
                    "range": [
                        "text": " O ",
                        "color": UIColor.green
                    ]
                                           ...
                                           [
                                            "labels": [
                                                ...
                                                [
                                                    ...
                                                    "frame": CGRect(x:20, y:54, width:UIScreen.main.bounds.height - 40, height: 24),
                                                    "fontSize": 24
                                                ],
                                                [
                                                    "text": "You have to STOP your response on stop trials:",
                                                    "frame": CGRect(x:20, y:104, width:UIScreen.main.bounds.height - 40, height: 28),
                                                    "fontSize": 24
                                                ],
                                                [
                                                    "text": "DO NOT press any key when a box appears around the X or O",
                                                    "frame": CGRect(x:20, y:144, width:UIScreen.main.bounds.height - 40, height: 70),
                                                    "line": 2,
                                                    "fontSize": 24
                                                ],
                                                [
                                                    "text": "For example, like this: ",
                                                    "frame": CGRect(x:20, y:214, width:UIScreen.main.bounds.height - 40, height: 40),
                                                    "fontSize": 24
                                                ],
                                                [
                                                    "text": "X",
                                                    "frame": CGRect(x:UIScreen.main.bounds.height / 2 - 30, y:254, width:60, height: 60),
                                                    "fontSize": 40,
                                           ...
                                           [
                                            "labels": [
                                                [
                                                    ...
                                                    "frame": CGRect(x:20, y:40, width:UIScreen.main.bounds.height - 40, height: 24),
                                                    "fontSize": 24
                                                ],
                                                [
                                                    "text": "DO NOT WAIT for a stop signal to occur.",
                                                    "frame": CGRect(x:20, y:84, width:UIScreen.main.bounds.height - 40, height: 24),
                                                    "fontSize": 24
                                                ],
                                                [
                                                    "text": "Let’s do a practice block.",
                                                    "frame": CGRect(x:20, y:144, width:UIScreen.main.bounds.height - 40, height: 24),
                                                    "fontSize": 24
                                                ],
                                                [
                                                    "text": "Press <next page> to proceed.",
                                                    "frame": CGRect(x:20, y:168, width:UIScreen.main.bounds.height - 40, height: 24),
                                                    "fontSize": 24
                                                ],
                                                [
                                                    "text": "Press <skip> to go straight to the actual task.",
                                                    "frame": CGRect(x:20, y:192, width:UIScreen.main.bounds.height - 40, height: 24),
                                                    "fontSize": 24
                                                ]
                                            ],
                                            "next": "practice",
                                           ...
                                           [
                                            "labels": [
                                                [
                                                    ...
                                                    "frame": CGRect(x:20, y:40, width:UIScreen.main.bounds.height - 40, height: 40),
                                                    ],
                                                [
                                                    "text": "Let’s begin the actual task.",
                                                    "frame": CGRect(x:20, y:100, width:UIScreen.main.bounds.height - 40, height: 40),
                                                    ]
                                            ],
                                            "next": "experiment"
        ]];
    ...
    override func viewDidLoad() {
        ...
        block = [
            "align":NSTextAlignment.center,
            "fontSize": 100,
            "frame":CGRect(x:screenHeight / 2 - 50, y:screenWidth/2 - 60, width: 100, height: 100)
            ]
        ...
        _ = createTimer(interval: 4, repeats: false) { (timer) in
            self.clearViews();
    ...
    func renderRespondBtns() {
        renderBtns(btns: [[
            "text": "X",
            "frame": CGRect(x:20, y:20, width: screenWidth/2 - 20, height: screenHeight - 20),
            ...
            "color": UIColor.green
                ...
                "text": "O",
                "frame": CGRect(x:screenWidth/2, y:20, width: screenWidth/2 - 20, height: screenHeight - 20),
    ...
    func wrongRespond(string:String = "incorrect button") {
        ...
        if isPractice {
            ...
            if wrong >= 3 {
                label["text"] = "You MUST respond to X/O go stimuli as fast as possible";
                wrong = 0;
            }
        ...
        if isPractice {
            renderLabels(labels:[[
                ...
                "color": UIColor.red
                    ...
                    "text": "You should not have pressed any button",
                    "align":NSTextAlignment.center,
                    "frame":CGRect(x:0, y:self.screenHeight/2 + 20, width: self.screenWidth, height: 40),
                    "color": UIColor.red
                ]]);
...
//            self.renderFunctionalBtns();
    ...
    func renderResult() {
        ...
        var title = [
            ...
            "frame":CGRect(x:20, y:20, width: self.screenWidth, height: 24),
            "fontSize": 24
            ] as [String: Any];
        ...
        _ = createTimer(interval: 1, repeats: true) { (timer) in
            ...
            self.renderLabels(labels:[title,
                                      [
                                        ...
                                        "frame":CGRect(x:20, y:50, width: self.screenWidth, height: 24),
                                        "fontSize": 24
                ],[
                    "text": String(format: "Miss respondses: %li", miss.count),
                    "frame":CGRect(x:20, y:80, width: self.screenWidth, height: 24),
                    "fontSize": 24
                ],[
                    "text": fast.count > slow.count ? "" : "Too slow! Respond faster",
                    "frame":CGRect(x:20, y:110, width: self.screenWidth, height: 24),
                    "fontSize": 24
                ],[
                    "text": String(format: "Success Stop: %.02f%%", successPercent),
                    "frame":CGRect(x:20, y:140, width: self.screenWidth, height: 24),
                    "fontSize": 24
                ],[
                    "text": String(format: "Second left to wait: %li", 10 - count),
                    "frame":CGRect(x:20, y:170, width: self.screenWidth, height: 24),
                    "fontSize": 24
                ]]);
    ...
    func save(_ stack: Array<Int64>) {
        guard let result = try? JSONSerialization.data(withJSONObject: stack, options: []) else {
            return
        }
        
        let moc = (UIApplication.shared.delegate as! AppDelegate).managedObjectContext
        
        let sst = NSEntityDescription.insertNewObject(forEntityName: "SST", into: moc) as! SSTMO
        sst.cotent = String(data: result, encoding: .utf8)
        
        User.model?.addToSst(sst)
    }
